...
//     const targetAspectRatio = (image.width / image.height);
//     let canvasWidth, canvasHeight;
...
//     <div 
//       ref={containerRef}
//       className="flex w-full h-full min-h-[250px] relative md:mb-10"
//     >
//       <canvas 
//         ref={canvasRef} 
...
//   // Modified canvas setup for full screen
//   const setupCanvas = () => {
//     const canvas = canvasRef.current;
//     if (!canvas || !imageRef.current) return;
...
//     // Calculate dimensions to fill screen while maintaining image aspect ratio
//     const image = imageRef.current;
...
//       // Viewport is wider than image - fill height
//       canvasHeight = height;
//       canvasWidth = canvasHeight * imageAspectRatio;
//     } else {
//       // Viewport is taller than image - fill width
//       canvasWidth = width;
//       canvasHeight = canvasWidth / imageAspectRatio;
//     }
...
//     window.addEventListener('resize', handleResize);
//     // Initial setup with small delay to ensure everything is ready
//     const initTimeout = setTimeout(handleResize, 50);
