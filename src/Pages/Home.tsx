...
//   // function setHoveredIndex(arg0: null): void {
...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full min-h-screen bg-blue-500 text-white text-center px-6 py-8 relative">
  ...
  <WaveAnimation/>
      ...
      {/* Header Section */}
      <header className="w-full flex flex-col items-center text-center mt-6">
        <h1 className="text-4xl font-bold text-red-300">AG STAMP</h1>
        <p className="text-lg font-medium mt-2">Specializing in philately of Russia & Area</p>
      </header>
