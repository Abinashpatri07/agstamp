...
import React, { useState } from "react";
import { banner, img10, img7, img8, img9} from "../assets/image"; // Import the top image
import StampCarousel from "./StampCarousel";
import WaveAnimation from "../Components/WaveAnimation/WaveAnimation";
...
const Home: React.FC = () => {
  ...
  const stampCategories = [
    { name: "Imperial", image: img9 },
    { name: "USSR ", image: img7 },
    
   
   
    { name: "RSFSR ", image: img8 },
    { name: "Airmail", image: img10 },
